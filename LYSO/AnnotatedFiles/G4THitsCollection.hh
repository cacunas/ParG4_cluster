...
class G4HitsCollection : public G4VHitsCollection
{
  ...
  protected:
     ...
     [elementType: LYSOHit*  ]
     [elementCount: { $ELE_COUNT = ((G4THitsCollection<LYSOHit>*)$THIS)->entries(); }]
     [elementGet: { $ELEMENT = (*((G4THitsCollection<LYSOHit>*)$THIS))[$ELE_INDEX]; }]
     [elementSet: { ((G4THitsCollection<LYSOHit>*)$THIS)->insert((LYSOHit*)$ELEMENT); }]
	*/
