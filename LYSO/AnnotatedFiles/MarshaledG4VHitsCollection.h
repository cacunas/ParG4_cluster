...
G4VHitsCollection* unmarshal() {
    ...
    if(msh_size <= MSH_HEADER_SIZE) {
        ...
        {
	param = new G4THitsCollection<LYSOHit>("","");
	}
        this->Shadowed_param = (ShadowedMarshaledG4VHitsCollection*)this->param;
...
void marshal3() {
    ...
    //Now just copy "get" functions here
    {
		G4THitsCollection<LYSOHit> *aObj254 = (G4THitsCollection<LYSOHit>*)param;
...
void unmarshal3() {
    ...
    //Now copy the setspec here
    {
		MarshaledG4THitsCollection<LYSOHit> marObj(msh_cursor);
		marObj.unmarshalTo((G4THitsCollection<LYSOHit>*)param);
